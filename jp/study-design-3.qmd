...
::: {.callout-note appearance="simple" title="アウトカムは解析計画への橋"}
アウトカムを定義するとは、名前を決めるだけではありません。どの出来事をイベントに含めるか、いつから時間を数えるか、どの時点で評価するかを決めることです。

この定義が決まると、調査票や診療録から集めるべき情報、欠測時の扱い、解析方法、結果の解釈がつながります。OS、DFS、RFSの違いは、解析の前に研究の問いそのものを形にしていると考えると理解しやすくなります。
:::
