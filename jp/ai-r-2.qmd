...
# AI & R Workflows II − R Demonstration of Bias in Kaplan-Meier Under Competing Risks

::: {.serif-block .text-right}
R packages: cifmodeling
:::
...
- Kaplan-Meier曲線とAalen-Johansen曲線の使い分け（このエピソード）: **cifmodeling**
- 交絡調整の仮定宣言・診断: **dagitty**と**cobalt**
- 交絡調整の実行: **WeightIt**
...
::::::::::::::::::::::::::::::::: dialogue
::: voice-father
お父さん「おはよう。もし時間があるなら、この前やったRの話の続きをしてもいいかな。以前、臨床研究ではランダム誤差とバイアスに気をつけろって言ったの、覚えてる？」
:::

::: voice-daughter
私「覚えてるよ。でもバイアスって疫学で習うものだよね。統計とかRの本を読んでもバイアスなんて見たことがない。統計解析とどういう関係があるの？」
:::
...
::: voice-father
お父さん「統計学ではよく、シミュレーションっていってデータを乱数で発生させて実験するんだ。**Kaplan-Meier曲線を**描こうとすると、**競合リスク**の扱いによってはバイアスが生じるってことをみせてあげるよ、バイアスがどれくらい困ったことなのか実感ないでしょ？データが集まらないと。Rスクリプトをいじるだけですぐ終わるから」
:::
...
::: voice-daughter
私「あ、糖尿病合併症じゃなくて、がんの再発データにしてよ。そっちのが実感がわくんだ」
:::
:::::::::::::::::::::::::::::::::
...
### もしオンコロジー領域のアウトカムについて詳しく知りたい方は、"A Conversation on Causality at Our Table"のこのエピソードもご覧ください。
