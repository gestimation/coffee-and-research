...
このDAGを使って何がわかるかをみるため、Rの**dagitty**パッケージを実行してみます。
```{r warning=FALSE}
...
::::::::::::::::::::::::::::::::: dialogue
::: voice-father
私「ふむ。今回も呪文の意味はわからぬが、とりあえず、`dagitty()`の出力を`plot()`に入れるとDAGが描けたね。そして`adjustmentSets()`の出力を`print()`に入れると、交絡因子はBとC、AとCって表示された」
:::

::: voice-father
お父さん「その通り。ここからは、DAGから交絡因子を探すアルゴリズムの話なんだけど、そのためには同時分布と条件付分布が要る。人によっては復習が必要かもしれない」
:::
::::::::::::::::::::::::::::::::: 
...
::::::::::::::::::::::::::::::::: dialogue
::: voice-father
お父さん「復習はできた？じゃあDAGと確率変数の関係について説明しよう」
:::
