...
::: voice-father
お父さん「その通り。ここからは、どうやってDAGから交絡因子として調整すべき変数たちを探すかっていうアルゴリズムの話をするねｄｄ。そのためには同時分布と条件付分布が要る。人によっては復習が必要かもしれない」
:::
::::::::::::::::::::::::::::::::: 
...
結論をいうと、パスE←A→C←B→Dをブロックするため、Cに加えて、AまたはBを調整する必要があります。この変数の組み合わせは`dagitty()`と`adjustmentSets()`の実行結果と同じですよね。
:::
