...
::: voice-father
お父さん「比較可能性を高めるための統計手法やRパッケージもある。回帰調整のための`glm()`やプロペンシティスコア調整のための`WeightIt()`とかね。一方で、対象集団は広い方が、**一般化可能性（generalizability）**が高い。がんサバイバーの復職率を推定したいんだったら、がん種を限定する必要はないし、できれば複数の施設で調査したいよね」
:::
