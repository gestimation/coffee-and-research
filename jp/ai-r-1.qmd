...
::: {.callout-note appearance="simple" collapse="true" title="データセットの一部の出力結果はこちら"}
```{r}
head(dat)
```
:::

::: {.callout-note appearance="simple" collapse="true" title="変数名とデータの型の出力結果はこちら"}
```{r}
sapply(dat, class)
```
:::
...
::: {.callout-note appearance="simple" collapse="true" title="欠測状況を調べるRコードと結果はこちら"}
```{r warning=FALSE}
...
::: {.callout-note appearance="simple" collapse="true" title="Table 1のためのRコードはこちら"}
```{r, eval=FALSE}
...
::: {.callout-note appearance="simple" collapse="true" title="Table 1を改良したRコードはこちら"}
```{r, eval=FALSE}
table1 <- dat[, c(exposure_var, continuous_var, binary_var)] %>%
    tbl_summary(
        by = exposure_var,
...
::: {.callout-note appearance="simple" collapse="true" title="Table 1を検証するためのRコードと結果はこちら"}
```{r warning=FALSE}
