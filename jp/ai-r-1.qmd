...
::::::::::::::::::::::::::::::::: dialogue
::: voice-daughter
私「おはよう、今朝は冷えるね。ご飯食べてるところ悪いんだけど、ちょっと聞きたいことがあるんだけど。統計解析するときどのアプリを使ってる？あ、コーヒーもらっていい？」
:::
...
"`gtsummary::tbl_summary()`を使って曝露群と非曝露群で層別した集計表を作って"
...
”平均とSDに変更して。全体の集計結果とp値を表す列を追加して。桁数も整えて。連続変数の指標と割合は小数点1桁まで、p値は小数点3桁まで表示。変数名じゃなくてラベルをつけて”
...
::: voice-father
お父さん「そうそう。それであってる。ただし、患者背景のバランスをみるときは、p値より標準化差（SMD）を使うことが多いけどね。それともうひとつやることがある」
:::
::::::::::::::::::::::::::::::::: 
