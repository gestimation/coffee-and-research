...
::: {.callout-note appearance="simple" collapse="true" title="R操作で迷ったときの参考資料"}
詳しい使い方や、`janitor`, `dplyr`, `gtsummary`, `rstatix`, base Rを使った記述統計表の作成方法については、「疫学のためのRハンドブック」の[記述統計表の作り方](https://www.epirhandbook.com/jp/new_pages/tables_descriptive.jp.html)も参考になります。
:::
