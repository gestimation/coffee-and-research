...
はじめて研究に取り組む娘と統計家の父。父に研究仮説は"PICO"を"PECO"で整理するといいとアドバイスされ、医師である娘は、がんサバイバーにおけるストーマ造設と復職状況の関係を調査することに決める。臨床論文について父に教わるなかで、p値や95%信頼区間の裏には「頻度論的確率」があると言われる。使い方のルールは理解したものの、p<0.05や95%の数字がなんの役に立つのか説明がないなって思ったのだった。
:::
...
::::::::::::::::::::::::::::::::: dialogue
::: voice-daughter
私「おはよう、今朝は冷えるね。お食事中、ちょっといいかな、ひとつ聞きたいと思っていたことがあって。**95%信頼区間（confidence interval）**ってあるじゃない？あ、コーヒーもらっていい？」
:::

::: voice-father
お父さん「どうぞ、まだ冷めてないと思う。信頼区間がどうしたの？」
:::

::: voice-daughter
私「みんな当たり前のように95%っていうけど、ほんとに95%も当たってるの？」
:::
...
::: voice-daughter
私「ふーん。シミュレーションってあるじゃない？あれで証明できる？」
:::

::: voice-father
お父さん「ああ、そういうこと。じゃあハザード比の95%信頼区間の被覆確率（coverage）を出してみようか。Rでね」
:::

::: voice-daughter
私「つまりは実際に100回に95回当たるかどうかがcoverageってことよね」
:::

::: voice-father
お父さん「そう。信頼区間が真値を当てる頻度を、シミュレーションデータで数えるんだ。じゃあcoverageを出すとして、前提条件を整理しよう。2群比較の生存曲線を比べたいんだよね」
:::
...
::: voice-father
お父さん「そう。以前JCOG9502の話をしたとき、"p値が0.05だったら100回に5回は正しい"って言ったのを思い出してよ。他人の研究と自分の経験は違って見えるものだけど第三者が見れば同じこと。それでね、生存曲線の形は指数分布で決める。途中で追跡できなかった患者は打ち切り扱いになるけど、それも指数分布で発生させる。この設定だと、Cox回帰の仮定はすべて正しい。だから理論的にcoverageは95%になるはず」
:::
...
::: voice-father
お父さん「教科書的にいうとね。同じようなデータを何度も集めて、毎回95%信頼区間を作ったとき、"真の値を含む区間"の割合が0.95になるように設計された指標なんだ。これを"in the long run"の性能って言ったりする。でも、概念的に理解するよりも、シミュレーションを行った方が分かりやすいと思って」
:::
